...
Static Site Generation — 빌드 타임에 HTML을 미리 생성하여 정적 파일로 배포하는 렌더링 방식입니다.
...
SSG는 성능이 가장 우수하지만 실시간성이 없습니다. Next.js에서는 `generateStaticParams` 또는 `getStaticProps`로 구현합니다.
