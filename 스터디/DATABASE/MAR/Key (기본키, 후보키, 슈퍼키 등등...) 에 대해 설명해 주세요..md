---
title: "Key (기본키, 후보키, 슈퍼키 등등...) 에 대해 설명해 주세요."
tags: [SQL, 데이터베이스]
status: published
---
...
|키|유일성|최소성|NULL|설명|
|---|---|---|---|---|
|**슈퍼키**|O|X|-|튜플을 유일하게 식별할 수 있는 **모든** 속성 집합|
|**후보키**|O|O|-|슈퍼키 중 최소한의 속성만으로 구성된 키|
|**기본키**|O|O|X|후보키 중 대표로 선택된 키|
|**대체키**|O|O|-|후보키 중 기본키로 선택되지 않은 나머지 키|
|**대리키**|O|O|X|식별을 위해 **인위적으로 생성**한 기본키|
|**외래키**|X|X|-|다른 테이블의 기본키를 참조하는 속성|
